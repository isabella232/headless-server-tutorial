...
For example, for __siteId__ "abffe57734feeee" and __type__ "CMPicture", the YAML of the GraphQL query would look like this:
...
We've demonstrated how the Headless Server can be used to access assets, and we've shown how these assets can
...
If you have to build more complex GraphQL queries for the Headless Server, it's worth it to try the 
